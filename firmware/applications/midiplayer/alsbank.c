...
/*****************************************************************************
*
* Загрузка САМИХ СЕМПЛОВ в SDRAM.
*
*	UWord32 snd_load_tbl( char * name, UInt32 addr )
*
*	name 		имя файла
*	addr		адрес куда поместить файл
*	
*	возвращаяет размер файла в словах
*
*****************************************************************************/
