	...
	.ApplicationCode :
	{
      # Place all code into External Program RAM
		...
		* (user.text)
        ...
        # DTMF detect program memory sections start here
        #-----------------------------------------------
        ...
        * (sil_low.text)
        ...
        # DTMF detect program memory sections end here
        #---------------------------------------------
...
#*******************************************************************************
	.ApplicationData :
	{
		...
		* (rtlib.data)
        ...
        # DTMF detect external data starts here
        #--------------------------------------
        
		* (dtmf_xrom.data)
		* (dtmf_xram.data)
        
        # DTMF detect external data ends here
        #------------------------------------
