...
#define AL_SF_ALOCATED  0x0020	// Имеет полифонический голос
#define AL_SF_ZERO  	0x0040	// Имеет громкость равную 0
#define AL_SF_TARGET  	0x0080	// Имеет громкость равную заданной
