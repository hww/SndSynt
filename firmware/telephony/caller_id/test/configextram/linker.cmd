	...
	.ApplicationCode :
	{
      # Place all code into External Program RAM
		...
		* (user.text)
        ...
        # Caller ID program memory sections start here
        #---------------------------------------------
        ...
        * (CID_DC.text)
        ...
        # Caller ID program memory sections end here
        #-------------------------------------------
...
#*******************************************************************************
	.ApplicationData :
	{
		...
		* (rtlib.data)
        ...
        # Caller ID external data starts here
        #------------------------------------
        
        * (CallerID_Init.data)
    	* (CALLER_ID.data)
        
        # Caller ID external data ends here
        #----------------------------------
...
#*******************************************************************************
    ...
    # Caller ID internal data starts here
    #------------------------------------
    .cid_int_data :
    {
		* (CID_DC.data)
    ...
    # Caller ID internal data ends here
    #----------------------------------
