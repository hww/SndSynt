...
;
; Description:  Assembly module for Complex IFFT
;
; Modules
...
FFT_OUTPUT_IS_BITREVERSED         equ   8   ;Default to normal (linear)
    ...
    DEFINE    pCIFFT         'X:(SP-1)'   ;r2 -> pCIFFT
...
;----------------------------------------
; Extract information from pCIFFT
;----------------------------------------
    
    move    r2,pCIFFT                     ;Store pointer to pCFFT.
...
;---------------------------------------------------------------
    ...
    move    x:(r2+Offset_No_of_Stages),y1
    move    r3,r2                         ;r2 -> pX 
    move    pZ,r3                         ;r3 -> pZ.
    move    r3,pZZ                        ;pZZ = pZ
    ...
    move    #-Scratch_Size,n              ;Restore original stack pointer.
    lea     (sp)+n
