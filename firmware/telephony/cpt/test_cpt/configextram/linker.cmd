	...
	.ApplicationCode :
	{
      # Place all code into External Program RAM
		...
		* (user.text)		
	    ...
	    # CPT Program memory sections 
	    #-----------------------------

           * (cpt_code.text)

	    # CPT Program memory sections end here 
	    #-------------------------------------
...
#*******************************************************************************
	.ApplicationData :
	{
		...
		* (rtlib.data)
	    ...
	    # CPT data memory sections 
	    #-------------------------

        * (cpt_data.data)
		
	    # CPT data memory sections end here 
	    #----------------------------------
		...
		* (.bss)
	    ...
	    # CPT bss memory sections 
	    #------------------------

        .=ALIGN(16);
        * (cpt_data.bss)

	    # CPT bss memory sections end here 
	    #---------------------------------
