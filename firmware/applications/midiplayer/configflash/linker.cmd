...
MEMORY {
	...
	.xIntRAM            (RW)  : ORIGIN = 0x0040, LENGTH = 0x0800
	.xIntRAM_Mirror     (RWX) : ORIGIN = 0x0040, LENGTH = 0x0800  
	.xIntRAM_DynamicMem (RW)  : ORIGIN = 0x0840, LENGTH = 0x0660
   ...
   .xReserved          (R)   : ORIGIN = 0x1400, LENGTH = 0x0400  
	...
	.xExtRAM            (R)   : ORIGIN = 0x2000, LENGTH = 0x6000
	.xExtRAM_DynamicMem (RW)  : ORIGIN = 0x8000, LENGTH = 0x7770 
