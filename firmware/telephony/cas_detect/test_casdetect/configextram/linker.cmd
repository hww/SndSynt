	...
	.ApplicationCode :
	{
      # Place all code into External Program RAM
		...
		* (user.text)
        ...
        # CAS detect program memory sections start here
        #-----------------------------------------------

        * (CAS_DETECT.text)

        # CAS detect program memory sections end here
        #---------------------------------------------
...
#*******************************************************************************
	.ApplicationData :
	{
		...
		* (rtlib.data)
        ...
        # CAS detect external data starts here
        #--------------------------------------
        
	    * (CAS_DETECT.data)
        
        # CAS detect external data ends here
        #------------------------------------
