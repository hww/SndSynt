...
* File Name:         const.c
*
* Description:       File to hold all SDK constant that should be wrote in 
*                    Data Flash or Data ROM
*
* Modules Included:  
*                    
* 
...
/*****************************************************************************/
#define GPR_TO_IPR_MASK(x)  (x==0 ? 0x01FF : \
							(x==1 ? 0x7FFF : \
							(x==2 ? 0x3FFF : \
							(x==3 ? 0x1FFF : \
							(x==4 ? 0x0FFF : \
							...
							(x==6 ? 0x03FF : \
						 /* else */ 0x01FF))))))) 
#if GPR_INT_PRIORITY_0 > 1     \
    || GPR_INT_PRIORITY_1  > 1  \
    || GPR_INT_PRIORITY_2  > 1  \
    || GPR_INT_PRIORITY_3  > 1  \
    || GPR_INT_PRIORITY_4  > 1  \
    || GPR_INT_PRIORITY_5  > 1  \
    || GPR_INT_PRIORITY_6  > 1  \
    || GPR_INT_PRIORITY_7  > 1  \
    || GPR_INT_PRIORITY_8  > 1  \
    || GPR_INT_PRIORITY_9  > 1  \
    || GPR_INT_PRIORITY_10 > 1  \
    || GPR_INT_PRIORITY_11 > 1  \
    || GPR_INT_PRIORITY_12 > 1  \
    || GPR_INT_PRIORITY_13 > 1  \
    || GPR_INT_PRIORITY_14 > 1  \
    || GPR_INT_PRIORITY_15 > 1  \
    || GPR_INT_PRIORITY_16 > 1  \
    || GPR_INT_PRIORITY_17 > 1  \
    || GPR_INT_PRIORITY_18 > 1  \
    || GPR_INT_PRIORITY_19 > 1  \
    || GPR_INT_PRIORITY_20 > 1  \
    || GPR_INT_PRIORITY_21 > 1  \
    || GPR_INT_PRIORITY_22 > 1  \
    || GPR_INT_PRIORITY_23 > 1  \
    || GPR_INT_PRIORITY_24 > 1  \
    || GPR_INT_PRIORITY_25 > 1  \
    || GPR_INT_PRIORITY_26 > 1  \
    || GPR_INT_PRIORITY_27 > 1  \
    || GPR_INT_PRIORITY_28 > 1  \
    || GPR_INT_PRIORITY_29 > 1  \
    || GPR_INT_PRIORITY_30 > 1  \
    || GPR_INT_PRIORITY_31 > 1  \
    || GPR_INT_PRIORITY_32 > 1  \
    || GPR_INT_PRIORITY_33 > 1  \
    || GPR_INT_PRIORITY_34 > 1  \
    || GPR_INT_PRIORITY_35 > 1  \
    || GPR_INT_PRIORITY_36 > 1  \
    || GPR_INT_PRIORITY_37 > 1  \
    || GPR_INT_PRIORITY_38 > 1  \
    || GPR_INT_PRIORITY_39 > 1  \
    || GPR_INT_PRIORITY_40 > 1  \
    || GPR_INT_PRIORITY_41 > 1  \
    || GPR_INT_PRIORITY_42 > 1  \
    || GPR_INT_PRIORITY_43 > 1  \
    || GPR_INT_PRIORITY_44 > 1  \
    || GPR_INT_PRIORITY_45 > 1  \
    || GPR_INT_PRIORITY_46 > 1  \
    || GPR_INT_PRIORITY_47 > 1  \
    || GPR_INT_PRIORITY_48 > 1  \
    || GPR_INT_PRIORITY_49 > 1  \
    || GPR_INT_PRIORITY_50 > 1  \
    || GPR_INT_PRIORITY_51 > 1  \
    || GPR_INT_PRIORITY_52 > 1  \
    || GPR_INT_PRIORITY_53 > 1  \
    || GPR_INT_PRIORITY_54 > 1  \
    || GPR_INT_PRIORITY_55 > 1  \
    || GPR_INT_PRIORITY_56 > 1  \
    || GPR_INT_PRIORITY_57 > 1  \
    || GPR_INT_PRIORITY_58 > 1  \
    || GPR_INT_PRIORITY_59 > 1  \
    || GPR_INT_PRIORITY_60 > 1  \
    || GPR_INT_PRIORITY_61 > 1  \
    || GPR_INT_PRIORITY_62 > 1  \
    || GPR_INT_PRIORITY_63 > 1
    
EXPORT const Word16 configNestedIPRmask [64] = 
	{
		1,    /* Boolean flag for dispatcher that enables nested interrupts */
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_1), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_2), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_3), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_4), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_5), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_6), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_7), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_8), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_9), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_10), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_11), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_12), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_13), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_14), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_15), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_16), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_17), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_18), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_19), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_20), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_21), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_22), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_23), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_24), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_25), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_26), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_27), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_28), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_29), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_30), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_31), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_32), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_33), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_34), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_35), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_36), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_37), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_38), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_39), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_40), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_41), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_42), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_43), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_44), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_45), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_46), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_47), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_48), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_49), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_50), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_51), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_52), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_53), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_54), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_55), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_56), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_57), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_58), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_59), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_60), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_61), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_62), 
		GPR_TO_IPR_MASK(GPR_INT_PRIORITY_63) 
	};

#else
EXPORT const Word16 configNestedIPRmask [1] = 
	{
		0,    /* Boolean flag for dispatcher that disables nested interrupts */
	};
#endif
...
/*****************************************************************************/
	...
	const io_sInterface gpiodrvIOInterfaceVT = {
		gpiodrvIOClose,
		NULL,
		NULL,
		NULL
	...
	const io_sDriver gpiodrvIODevice = {
...
/*****************************************************************************/
	...
	const io_sInterface leddrvIOInterfaceVT = {
		leddrvIOClose,
		NULL,
		NULL,
		NULL
	...
	const io_sDriver leddrvIODevice = { 
		(io_sInterface *)&leddrvIOInterfaceVT, 
		NULL};
...
/*****************************************************************************/
	...
	const UWord16 qtExtAMode[12] = {
    	0,
    	QTB_COUNTMODE( qtCount ),
	    QTB_COUNTMODE( qtCountBothEdges ),
	    QTB_COUNTMODE( qtGatedCount ),
 	   	QTB_COUNTMODE( qtQuadratureCount ),
 	   	QTB_COUNTMODE( qtSignedCount ),
 	   	QTB_COUNTMODE( qtTriggeredCount ),
 	   	QTB_COUNTMODE( qtCascadeCount ),
 	   	QTB_COUNTMODE( qtOneShot ) | QTB_LENGTH | QTB_ONCE | QTB_OUTPUTMODE(qtDeassertOnSecondary),
 	   	QTB_COUNTMODE( qtPulseOutput ) | QTB_ONCE | QTB_OUTPUTMODE(qtAssertOnGatedClock),
 	   	QTB_COUNTMODE( qtFixedFreqPWM ) | QTB_OUTPUTMODE(qtDeassertOnCounterRollover),
 	   	QTB_COUNTMODE( qtFixedFreqPWM ) | QTB_LENGTH | QTB_OUTPUTMODE(qtToggleUsingAlternateCompare)
	};

	const UWord16 qtExtAMask[12] = {
    	0x1FFF, 0x1FFF, 0x1FFF, 0x1FFF,    0x1FFF, 0x1FFF, 0x1FFF, 0x1FFF, 
    	0x1FF8 & ~QTB_LENGTH & ~QTB_ONCE, 
    	0x1FF8 & ~QTB_ONCE,
    	0x1FF8 & ~QTB_LENGTH & ~QTB_ONCE,
    	0x1FF8 & ~QTB_LENGTH & ~QTB_ONCE
	};
	...
	const qt_tQTConfig qtDeviceMap[] =
	{  

		/****   AAAA     ****/
		#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_0) && defined(INCLUDE_USER_TIMER_A_0)
    		{ &ArchIO.TimerA.Channel0, &qt_ctx_A_0 },
		#endif

		#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_1) && defined(INCLUDE_USER_TIMER_A_1)
    		{ &ArchIO.TimerA.Channel1, &qt_ctx_A_1 },
		#endif

		#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_2) && defined(INCLUDE_USER_TIMER_A_2)
    		{ &ArchIO.TimerA.Channel2, &qt_ctx_A_2 },
		#endif 

		#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_3) && defined(INCLUDE_USER_TIMER_A_3)
   		 	{ &ArchIO.TimerA.Channel3, &qt_ctx_A_3 },
		#endif 
	...
	const int     qtNumberOfDevices = sizeof( qtDeviceMap ) / sizeof( qtDeviceMap[0] );
	const UWord32 qtINPUT_FREQUENCY = BSP_OSCILLATOR_FREQ * PLL_MUL /2 /2;


	#ifdef INCLUDE_IO_QUAD_TIMER
		#include "qtimerdrvIO.h"
		
		const io_sInterface qtimerdrvIOInterfaceVT = 
		{
    		qtClose,
    		0,
    		0,
		...
		/*
			The following table uses QTxx preprocessor variables to 
			calculate a constant index into the qtDeviceMap sparse array
		*/
		const io_sDriver qtimerdrvIODevice[] = 
		{
			#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_0) && defined(INCLUDE_USER_TIMER_A_0)
      			{ (io_sInterface *)&qtimerdrvIOInterfaceVT, (int)((qt_tQTConfig *)&qtDeviceMap[0]) },
      			#define QTA0 1
			#else 
     			#define QTA0 0
			#endif
			...
			#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_1) && defined(INCLUDE_USER_TIMER_A_1)
      			{ (io_sInterface *)&qtimerdrvIOInterfaceVT, (int)((qt_tQTConfig *)&qtDeviceMap[QTA0]) },
      			#define QTA1 1
			#else 
     			#define QTA1 0
			#endif
			...
			#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_2) && defined(INCLUDE_USER_TIMER_A_2)
      			{ (io_sInterface *)&qtimerdrvIOInterfaceVT, (int)((qt_tQTConfig *)&qtDeviceMap[QTA0+QTA1]) },
      			#define QTA2 1
			#else 
     			#define QTA2 0
			#endif
			...
			#if defined(BSP_DEVICE_NAME_QUAD_TIMER_A_3) && defined(INCLUDE_USER_TIMER_A_3)
      			{ (io_sInterface *)&qtimerdrvIOInterfaceVT, (int)((qt_tQTConfig *)&qtDeviceMap[QTA0+QTA1+QTA2]) },
      			#define QTA3 1
			#else 
     			#define QTA3 0
			#endif
...
#if (TIMER_TICK_NANOSECONDS <= 1000000)

		/* Timer range <= 1ms */
		const qt_eInputSource timerInputSource = qtPrescalerDiv1;
		const UWord16 timerTickLoadValue   = BSP_OSCILLATOR_FREQ * PLL_MUL / 2 / 2 / (1000000000L / TIMER_TICK_NANOSECONDS);
		const UWord16 timerNanosecPerCount = (UWord16)( 1000000000L / ( BSP_OSCILLATOR_FREQ * PLL_MUL / 2 / 2 ) );
		
#elif (TIMER_TICK_NANOSECONDS <= 100000000)

		/* Timer range <= 100ms */
		const qt_eInputSource timerInputSource = qtPrescalerDiv128;
		const UWord16 timerTickLoadValue   = BSP_OSCILLATOR_FREQ * PLL_MUL / 2 / 2 / 128 / (1000000000L / TIMER_TICK_NANOSECONDS);
		const UWord16 timerNanosecPerCount = (UWord16)( 1000000000L / ( BSP_OSCILLATOR_FREQ * PLL_MUL / 2 / 2 / 128 ) );
		
#else

#error "TIMER_TICK_NANOSECONDS exceeds implementation limit of 100 milliseconds"

#endif

		const Word32  timerTickNanoseconds = TIMER_TICK_NANOSECONDS;
		const Word32  timerTickHZ          = 1000000000 / TIMER_TICK_NANOSECONDS;
...
/*****************************************************************************/
	...
	const io_sDriver spidrvIODevice[2] = 
	{
...
/*****************************************************************************/
	...
	extern button_sButton buttondrvDeviceA;
	extern button_sButton buttondrvDeviceB;

	const io_sInterface buttondrvIOInterfaceVT = {
		buttonClose,
		NULL,
		NULL,
		NULL
	...
	const io_sDriver buttondrvIODeviceA = {
		(io_sInterface *)&buttondrvIOInterfaceVT, 
		(int)&buttondrvDeviceA};

	const io_sDriver buttondrvIODeviceB = {
		(io_sInterface *)&buttondrvIOInterfaceVT, 
		(int)&buttondrvDeviceB};
...
/*****************************************************************************/
	 ...
	 const UWord16 TodClockScaler = BSP_OSCILLATOR_FREQ / 128;  
